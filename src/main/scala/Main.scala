...
object Main {
  ...
  private[this] var maxTime3fRaceList: List[Long] = Nil

  private[this] val time3fRaceMap = Map[Int, List[(Int, Double, Double)]](
    CATEGORY_SHIBA_SHORT -> List(
      (1011200, 35.72979511143062, 1.0279668620866114),
      (1011500, 36.36524096385539, 1.1555021828293874),
      (2011200, 36.27376434762235, 1.1931978414264874),
      (3011200, 35.696440281030535, 1.1426624081551768),
      (4011200, 35.443937586048604, 0.9763215515617614),
      (4011400, 36.370645978467354, 1.2752696190485617),
      (4111600, 35.018672323434, 1.1476251430613995),
      (5011400, 35.29745200698084, 1.1600726158564252),
      (5011600, 35.680427605926635, 1.1407232129466839),
      (6111200, 35.49796541200404, 1.0388820629902389),
      (6111600, 36.272679701786465, 1.1422251992493607),
      (7011200, 35.56420132325149, 1.1119733078241145),
      (7011400, 36.574978279756694, 1.2006632127864723),
      (7011600, 36.604150943396196, 1.2160952801921898),
      (8011200, 35.132827054286556, 1.023174175599597),
      (8011400, 35.76355348635776, 1.0684022410275884),
      (8111400, 35.3726993865031, 1.0374253242480524),
      (8011600, 36.283097428638726, 1.191909412995646),
      (8111600, 35.90762160091917, 1.189835810475051),
      (9011200, 35.47698942229457, 1.0350978911048494),
      (9011400, 36.23898237179488, 1.108296794772634),
      (9111600, 35.79234473447351, 1.1739163480666071),
      (10011200, 35.51797268344933, 1.0594717023040627)
    ),
    CATEGORY_SHIBA_LONG -> List(
      (1011800, 36.09459007551244, 1.261932594858037),
      (1012000, 36.687333333333334, 1.3596929313622668),
      (2011800, 36.75029066802659, 1.5061260979230343),
      (2012000, 37.396873350923494, 1.687420879263155),
      (3011800, 36.155089360513794, 1.4436482312101377),
      (3012000, 36.6288241899262, 1.6809849502510228),
      (3012600, 37.03224643755245, 1.953247764232521),
      (4111800, 34.95015350877193, 1.2745449371555715),
      (4012000, 36.220415149308054, 1.3664346424875793),
      (4112000, 35.09923676012457, 1.2531136258819677),
      (4012200, 36.19499557130203, 1.3345830440913438),
      (5011800, 35.41559366754612, 1.562836458996014),
      ...
      (8012000, 35.60102999434079, 1.310426589418678),
      (8112200, 35.820471698113236, 1.4628392362203848),
      (8112400, 36.13108695652174, 1.6545274579723228),
      (9111800, 35.7188385269122, 1.407357436864946),
      ...
      (10011800, 35.905505222249105, 1.313088976475071)
    ),
    CATEGORY_DIRT_SHORT -> List(
      ...
      (3001150, 37.51706622516566, 1.069383812819924),
      ...
      (7001000, 36.306269841269734, 0.8503877060020076),
      (7001200, 37.589165398275, 1.1528430762321125),
      (7001400, 38.55037562604341, 1.447230406844544),
      ...
      (10001000, 35.953823788546306, 0.9932854562426685),
      (10001700, 39.1610430528376, 1.6540118473868566)
    ),
    CATEGORY_DIRT_LONG -> List(
      (4001800, 39.37387695955754, 1.76024798382762),
      (5002100, 39.004552285535366, 1.9742509558711114),
      (6001800, 39.880947063688934, 1.9730517873179063),
      (7001800, 39.04513761467885, 1.6598338902757281),
      (8001800, 38.76708769397332, 1.7363323685015226),
      (8001900, 38.69047006155571, 1.5476942364986326),
      (9001800, 38.94173310225296, 1.739957787269001),
      (9002000, 38.83643137254903, 1.5865047190301034)
    )
  )
  ...
  private[this] val timeRaceMap = Map[Int, List[(Int, Double, Double)]](
    CATEGORY_SHIBA_SHORT -> List(
      ...
      (2011200, 71.01930662918683, 1.527635488112701),
      (3011200, 70.28856178536985, 1.4832552743935143),
      (4011200, 70.51421294171643, 1.2408335946981068),
      (4011400, 83.35755541481931, 1.7079776043403587),
      (4111600, 96.11899176441229, 1.799560655785535),
      (5011400, 83.77683827806871, 1.7632745927203473),
      (5011600, 96.39092799584069, 2.0305398302801283),
      (6111200, 70.02206002034575, 1.3617828888766939),
      (6111600, 96.52681108454041, 2.1148937842186086),
      ...
      (8011200, 70.04075348561255, 1.2779664027090003),
      (8011400, 83.02236466002607, 1.3856530736884596),
      (8111400, 82.84229038854794, 1.2314045250761843),
      (8011600, 96.51297475819773, 1.5981810676330557),
      (8111600, 95.92052470317876, 1.6609618471671308),
      (9011200, 70.73244914564681, 1.3717250644644232),
      (9011400, 83.4606770833332, 1.4734245641344637),
      (9111600, 96.71004500450051, 1.8077114199275726),
      (10011200, 69.75270487412954, 1.4042418368174117)
    ),
    CATEGORY_SHIBA_LONG -> List(
      (1011800, 111.13313915857604, 2.2269048953416055),
      (1012000, 123.22654545454557, 1.746931001918637),
      (2011800, 111.33834778174414, 2.3702320133372285),
      (2012000, 123.94670184696589, 2.254533341361377),
      (3011800, 109.94930745601775, 2.2351769131542993),
      (3012000, 122.24654796278444, 2.2985173861879735),
      (3012600, 162.3473009220453, 2.7571052683201673),
      (4111800, 108.89203947368408, 1.9424703661063827),
      (4012000, 122.88402767662027, 1.97447838388934),
      (4112000, 121.05146417445479, 1.575442988644012),
      (4012200, 135.18350752878645, 1.8669808444569547),
      (5011800, 109.71523306948133, 2.2330566387842697),
      (5012000, 123.00564330543957, 2.42480057171173),
      (5012400, 148.78654791154817, 2.513832685679168),
      (6011800, 110.88166575041225, 2.312105303314178),
      (6012000, 123.37833122629552, 2.6855830285091202),
      (6112200, 136.73671874999986, 2.8721113736864856),
      ...
      (8112400, 148.38956521739133, 2.505581838106229),
      (9111800, 109.2779927154994, 2.083246229520343),
    ...
    CATEGORY_DIRT_SHORT -> List(
      (1001000, 60.21498701298702, 1.0884386108084438),
      (1001200, 122.21142857142861, 2.1842925271851628),
      (1001700, 108.14218779881466, 2.2091342584981106),
      (2001000, 60.19152081563298, 1.315948972428854),
      (2001700, 107.823879380603, 2.0660083076813702),
      (3001150, 70.20847019867542, 1.54337537960583),
      (3001700, 108.23178339350178, 2.0533199531550372),
      (4001200, 73.31299649690104, 1.62390216283417),
      ...
      (6001200, 73.3838257216424, 1.7918671009625888),
      (7001000, 60.41323809523819, 1.1992737864274874),
      (7001200, 73.49482496194825, 1.4406053462910529),
      (7001400, 86.51341402337217, 1.7228558697489882),
      (7001700, 108.20922046285023, 2.0745436512603725),
      (8001200, 73.71467553131009, 1.7216969869101255),
      (8001400, 86.53577096384202, 1.8714697657323283),
      (9001200, 73.70087912087921, 1.890763327337309),
      (9001400, 86.55569712981869, 1.8970243120400319),
      (10001000, 59.64290198237887, 1.298420031463923),
      (10001700, 107.37174902152653, 2.3795920033965743)
    ),
    CATEGORY_DIRT_LONG -> List(
      (4001800, 115.53665129758927, 2.302310098285448),
      (5002100, 135.74802755165958, 3.036325517902439),
      (6001800, 117.19180452164358, 2.848814458209519),
      (7001800, 115.92137614678924, 2.4294068583695996),
      (8001800, 115.08236376759333, 2.616957038338896),
      (8001900, 121.49903749300501, 2.2135110851092303),
      (9001800, 115.38791161178588, 2.553272323001846),
      (9002000, 127.39694117647062, 2.0245398086682442)
    )
  )
        ...
        (0 to 3).foreach {
          raceCategory =>
            ...
            val infos = for {
              ...
              time3f <- time3fRace.find(_._1 == race.raceType).toList
            } yield {
              val m = time._2
              val s = time._3
              ...
              (race.raceType, (m - race.time) / s * 10 + 50, (m3f - race.time3f) / s3f * 10 + 50)
            }
            if (infos.length > 3) {
              maxTimeRaceList = infos.maxBy(_._2)._1 :: maxTimeRaceList
              maxTime3fRaceList = infos.maxBy(_._3)._1 :: maxTime3fRaceList
            }
        }
...
//      "raceTime3fMean.csv" -> raceTime3fMap,
      ...
      "maxTime3fRace.csv" -> (maxTime3fRaceList.groupBy(x => x).map {
        case (key, value) =>
          key.asInstanceOf[Long] -> value.map(_.toDouble)
      }, raceTime3fMap)
    ).foreach {
        ...
        case (raceId, horses)  if horses.head.isGoodBaba =>
          ...
          val res = horses.zip(timeList).map {
            case (horse, prevStdList) =>
              val time = prevStdList.map(_._1).sortBy(-_) match {
                case Nil => Double.NaN
                case list => mean(list.take(3))
              }
              val time3f = prevStdList.map(_._2).sortBy(-_) match {
                case Nil => Double.NaN
                case list => mean(list.take(3))
              }
